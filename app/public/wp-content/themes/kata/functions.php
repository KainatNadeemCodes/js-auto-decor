...
if ( ! class_exists( 'Kata' ) ) {
	...
	class Kata {
		...
		public function dependencies() {
			 ...
			 */
			if ( is_admin() ) {
				require self::$dir . 'includes/updater/class-kata-theme-updater.php';
				new Kata_Theme_Updater( self::$version, self::$theme->get_template() );
			}
			...
			if ( file_exists( self::$dir . 'rtl-version.php' ) ) {
				require self::$dir . 'rtl-version.php';
			}
		}
		...
		public function body_classes( $classes ) {
			 ...
			 * Transparent header.
			 */
			if ('1' === Kata_Helpers::get_meta_box('kata_make_header_transparent') && ! Kata_Helpers::is_blog_pages() && ! is_page()) {
				$classes[] = 'kata-make-header-transparent';
			}
			if ('1' === Kata_Helpers::get_meta_box('kata_header_transparent_white_color') && ! Kata_Helpers::is_blog_pages() && ! is_page()) {
			 ...
			 */
			if (is_page()) {
				$transparent_meta = Kata_Helpers::get_meta_box('kata_make_header_transparent');
				if ('inherit_from_customizer' === $transparent_meta || false === $transparent_meta || empty($transparent_meta)) {
					if ('1' == get_theme_mod('kata_page_transparent_header', '0')) {
						$classes[] = 'kata-make-header-transparent';
					}
				} elseif ('1' === $transparent_meta) {
					$classes[] = 'kata-make-header-transparent';
				}

				$dark_transparent_meta = Kata_Helpers::get_meta_box('kata_header_transparent_white_color');
				if ('inherit_from_customizer' === $dark_transparent_meta || false === $dark_transparent_meta || empty($dark_transparent_meta)) {
					if ('1' == get_theme_mod('kata_page_header_transparent_white_color', '0') && '1' == get_theme_mod('kata_page_transparent_header', '0')) {
						$classes[] = 'kata-header-transparent-white-color';
					}
				} elseif ('1' === $dark_transparent_meta && '1' === $transparent_meta) {
					$classes[] = 'kata-header-transparent-white-color';
				}
			}
