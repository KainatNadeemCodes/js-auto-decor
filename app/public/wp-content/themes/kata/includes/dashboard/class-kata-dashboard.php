...
if ( ! class_exists( 'Kata_Dashboard' ) ) {
	...
	class Kata_Dashboard {
		...
		public function definitions() {
			...
			self::$facebook			= 'https://www.facebook.com/webnus/';
			self::$document_url		= 'https://webnus.net/kata/documentation/';
        ...
        public function install_activate_plugins() {
			...
			$plugins = [
				...
				[
					'name' => 'Kata Plus',
					'slug' => 'kata-plus',
					'url'  => 'https://my.webnus.net/api/products/download.php?kata-plus'
				]
			];
        ...
        public function kata_plus_install_notice() {
			...
			<div class="kata-notice kt-dashboard-box notice notice-success is-dismissible">
				...
				<p class="kt-notice-description"><?php echo __( 'To take full advantage of all the features in Kata theme and enabling its demo importer, please install the required plugins. This plugins grants you access to a range of powerful tools like', 'kata' ); ?></p>
				...
				<p>
					...
					<a href="https://webnus.net/kata/documentation" class="kt-notice-link"><?php echo __( 'Read full documentation', 'kata' ) ?></a>
				</p>
				</div>
			</div>
			<?php
