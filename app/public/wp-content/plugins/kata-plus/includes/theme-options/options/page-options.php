...
if ( ! class_exists( 'Kata_Plus_Theme_Options_Page' ) ) {
	class Kata_Plus_Theme_Options_Page extends Kata_Plus_Theme_Options {
		...
		new \Kirki\Field\Checkbox_Switch(
			array(
				'settings'    => 'kata_show_page_header',
				'section'     => 'kata_page_title_section',
				'label'       => esc_html__( 'Header', 'kata-plus' ),
				'description' => esc_html__( 'Show/Hide Header in Page', 'kata-plus' ),
				'default'     => '1',
				'priority'    => 1,
				'choices'     => array(
					'on'  => esc_html__( 'Show', 'kata-plus' ),
		...
		new \Kirki\Field\Radio_Buttonset(
			array(
				'settings'        => 'kata_page_transparent_header',
				'section'         => 'kata_page_title_section',
		...
		new \Kirki\Field\Radio_Buttonset(
			array(
				'settings'        => 'kata_page_header_transparent_white_color',
				'section'         => 'kata_page_title_section',
				...
				'active_callback' => array(
					array(
						'setting'  => 'kata_page_transparent_header',
						'operator' => '==',
						'value'    => '1',
					),
				),
