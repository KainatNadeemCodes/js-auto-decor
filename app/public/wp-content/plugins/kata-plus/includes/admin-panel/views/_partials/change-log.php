...
<pre>
	<!-- 1.6.2 -->
	<span class="version">1.6.2</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '28 June, 2026' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Fixed: Minor issues and stability improvements
	</div>
	<!-- 1.6.1 -->
	<span class="version">1.6.1</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '15 June, 2026' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Improved: Kata Importer performance and reliability
		• Improved: Overall Kata performance and optimization
		• Added: Swipe gesture support for Carousel Widget on touch devices
		• Compatibility: WordPress 7.x
		• Compatibility: WooCommerce 10.8 (verified templates and APIs)
		• Compatibility: WooCommerce High-Performance Order Storage (HPOS) and Cart & Checkout Blocks
		• Compatibility: Latest Elementor
		• Compatibility: PHP 8.x
		• Fixed: Hamburger Menu widget close icon overlapping the trigger and off-canvas panel display on legacy configurations
		• Fixed: Recipes widget image output (PHP error on render)
		• Fixed: Styler device switching issue
		• Fixed: Styler copy & paste functionality issue
		• Fixed: Styler color picker issue
		• Fixed: Minor issues and stability improvements
	</div>
	<!-- 1.6.0 -->
	<span class="version">1.6.0</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '23 November, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Styler: Box Shadow Horizontal & Vertical fixed
		• Styler: Add unset to position absolute
		• Imporoved: Styles in Customizer
		• Imporoved: Menu Widget Responsive toggle
		• Added: Aria Label to Social Share widget
		• Added: Climax Church Suite plugin
		• Added: Charity Demo
		• Added: Church 2 Demo
		• Added: Church Demo
		• Added: Perfume Demo
		• Added: Conference Demo
		• Added: Business Edge Demo
		• Added: Tattoo Workshop Demo
		• Added: Crypto Seminar Demo
		• Added: Boutique Demo
		• Fixed: Blog Post Styler 
		• Fixed: Brands Widget Column Counts
		• Fixed: Price Plan “0” Content entry and icon
		• Fixed: Icon position in Button widget
		• Fixed: Page Custom CSS
		• Fixed: Customizer maintenance mode
		• Fixed: Minor issues	
	</div>
		<!-- 1.5.6 -->
		<span class="version">1.5.6</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '23 September, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Improved: Styler Speed
		• Updated: Woocommerce templates
		• Fixed: Woopayment Multi Step Checkout Compatibility
		• Fixed: Style Duplicate issue
		• Fixed: Elementor paste from another site issue
		• Fixed: Security Issue
		• Fixed: Minor Issues
	</div>

	<!-- 1.5.5 -->
	<span class="version">1.5.5</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '01 July, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Improved: Importer API
		• Fixed: Product Compare Widget Fix (ShopPress)
		• Fixed: Title Dynamic Content
	...
	<!-- 1.5.4 -->
	<span class="version">1.5.4</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '31 May, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Fixed: Styler Translation
		• Fixed: Security Issues
		• Fixed: Minor Issues
	</div>

	<!-- 1.5.3 -->
	<span class="version">1.5.3</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '07 May, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Added: Flex Column and Row Gap to Styler
		• Added: Webinar Demo
		• Added: Marketing Seminar Demo
		• Added: Interior Design Event Demo
		• Updated: WooCommerce Template
		• Updated: ShopPress plugin (QR Code)
		• Compatible with: Woocommerce 9.8.4
		• Compatible with: WordPress 6.8.1
		• Fixed: Template Manager
		• Fixed: Minor issue in Login widget
		• Fixed: Importer Issues
		• Fixed: Minor Issues
	</div>

	<!-- 1.5.2 -->
	<span class="version">1.5.2</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '12 February, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Updated: WooCommerce My Account Template
		• Updated: WooCommerce Reviews Template
		• Updated: ShopPress plugin (Pro)
		• Improved: RTL Support
		• Improved: Styler
		• Compatible with: Woocommerce 9.6
	...
	<!-- 1.5.1 -->
	<span class="version">1.5.1</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '02 February, 2025' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Added: Mega Shop (Pro)
		• Added: Food & Beverage Shop (Pro)
		• Updated: WooCommerce Order Template
		• Updated: Essential Grid plugin (Pro)
		• Updated: FileBird Media Folders plugin (Pro)
		• Updated: Quform plugin (Pro)
		• Updated: LayerSlider plugin (Pro)
		• Updated: Slider Revolution plugin (Pro)
		• Updated: ShopPress plugin (Pro)
		• Improved: RTL Support
		• Improved: Admin RTL Support
		• Compatible with: WordPress 6.7
		• Fixed: Checkout Thank You Style
		• Fixed: Infinite Image Scroll
		• Fixed: Testimonial Ratings & Reviews
		• Fixed: Vertical Menu
		• Fixed: Minor Issues
	</div>

	<!-- 1.5.0 -->
	<span class="version">1.5.0</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '23 October, 2024' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Added: New Demo Wine Shop (Pro)
		• Added: New Demo Shoe Shop (Pro)
		• Added: New Demo Jewelry Shop (Pro)
		• Added: RTL Support
		• Updated: Styler
		• Updated: Domain checker widget
		• Updated: Word and sentences in the theme and plugin
		• Updated: Essential grid plugin (Pro)
		• Updated: Filebird media folders plugin (Pro)
		• Updated: Quform plugin (Pro)
		• Updated: Slider LayerSlider plugin (Pro)
		• Improvement: Hamburger & Responsive menu
		• Improvement: Spacer widget
		• Improvement: Login widget
		• Improvement: Search widget ( Ajax search & result )
		• Improvement: Importer functionality
		• Fixed: Font manager
	...
	<!-- 1.4.7 -->
	<span class="version">1.4.7</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '10 September, 2024' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Updated: Styler
		• Updated: Essential grid plugin (pro)
		• Updated: Filebird media folders plugin (pro)
		• Updated: Quform plugin (pro)
		• Updated: Slider LayerSlider plugin (pro)
		• Updated: ShopPress Pro Plugin (pro)
		• Fixed: Menu navigation vertical style
		• Fixed: Select Icon module in menu navigation
	</div>

	<!-- 1.4.6 -->
	<span class="version">1.4.6</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '10 September, 2024' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Updated: WooCommerce Templates
		• Updated: Styler
		• Fixed: WooCommerce Container size
		• Fixed: WooCommerce Quantity styling issue
		• Fixed: WooCommerce Quantity styling issue
		• Fixed: WooCommerce image size
		• Fixed: WooCommerce Filters styling issue
		• Fixed: Fatal Error when ShopPress is not installed
		• Fixed: Toggle Content widget
		• Fixed: Pricing Table widget
		• Fixed: Video Player widget
		• Fixed: URL replace in import process
		• Fixed: Authentication message in Font manager
		• Fixed: SVG styling option on tab widget
	</div>

	<!-- 1.4.5 -->
	<span class="version">1.4.5</span> – <span class="date"><?php echo esc_html( date_format( date_create_from_format( 'j F, Y', '20 August, 2024' ), get_option( 'date_format' ) ) ) . "\n"; ?></span>
	<div class="change-list">
		• Added: Kindergarten Demo
		• Added: Furniture 2 Shop Demo
		• Added: Electronics Shop Demo
		• Added: Sticky options to elementor's container
		• Changed: Blog Post widget grid system
		• Fixed: Styling issue in WooCommerce cart template
		• Fixed: Styling issue in quick view
		• Fixed: Layout shift on site load
		• Fixed: Header transparent conflict with hamburger menu
	</div>
