...
if (! class_exists('Kata_Plus_Elementor')) {
	class Kata_Plus_Elementor
	{
		...
		public function actions()
		{
			...
			add_filter('styler-localize-data', array($this, 'add_theme_css_variables_to_styler'), 10, 1);
					...
					$page->add_control(
						...
						array(
							...
							'raw'   => '<div class="elementor-nerd-box">
								...
								<a class="elementor-nerd-box-link elementor-button elementor-button-default elementor-button-go-pro" href="https://my.webnus.net/pricing" target="_blank">' . __('Kata Pro', 'kata-plus') . '</a>
							</div>',
						)
					);
		...
		/**
		 * Add theme CSS variable values to Styler so color preview in modal resolves correctly.
		 *
		 * @param array $data Styler localized data.
		 * @return array
		 */
		public function add_theme_css_variables_to_styler($data)
		{
			$data['themeCssVariables'] = array(
				'--ct-base-color'                  => get_theme_mod('kata_base_color', '#877ff3'),
				'--ct-color-primary'              => get_theme_mod('kata-color-primary', '#837af5'),
				'--ct-color-secondary'            => get_theme_mod('kata-color-secondary', '#1d2834'),
				'--ct-color-button-primary'       => get_theme_mod('kata-color-button-primary', '#f7f6ff'),
				'--ct-color-button-secondary'     => get_theme_mod('kata-color-button-secondary', '#2acf6c'),
				'--ct-color-border-button-primary' => get_theme_mod('kata-color-border-button-primary', '#e0deff'),
				'--ct-color-text-primary'         => get_theme_mod('kata-color-text-primary', '#737d8b'),
				'--ct-color-text-secondary'       => get_theme_mod('kata-color-text-secondary', '#959ca7'),
				'--ct-color-text-tertiary'        => get_theme_mod('kata-color-text-tertiary', '#b7bec9'),
				'--ct-color-heading-primary'       => get_theme_mod('kata-color-heading-primary', '#4c5765'),
				'--ct-color-heading-secondary'     => get_theme_mod('kata-color-heading-secondary', '#202122'),
				'--ct-color-onsale-primary'        => get_theme_mod('kata-color-onsale-primary', '#f37f9b'),
				'--ct-color-border-primary'        => get_theme_mod('kata-color-border-primary', '#e3e5e7'),
				'--ct-color-border-secondary'      => get_theme_mod('kata-color-border-secondary', '#f0f3f6'),
				'--ct-color-border-tertiary'       => get_theme_mod('kata-color-border-tertiary', '#cbc7fb'),
				'--ct-color-pagetitle-bg-primary' => get_theme_mod('kata-color-pagetitle-bg-primary', '#f6f7f8'),
			);
			return $data;
		}
	} // class
