...
class Kata_Accordion_Toggle extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_html_tag',
			array(
				'label'   => __( 'Title HTML Tag', 'kata-plus' ),
		...
		$this->add_control(
			...
			array(
				...
				'type'     => 'styler',
				'selector' => '.kata-accordion .kata-accordion-btn .kata-accordion-title',
				'isSVG'    => true,
				'isInput'  => false,
				'wrapper'  => '{{WRAPPER}}',
			)
		...
		$this->add_control(
			...
			array(
				'label'    => esc_html__( 'Title', 'kata-plus' ),
				'type'     => 'styler',
				'selector' => '.kata-accordion.active .kata-accordion-btn .kata-accordion-title',
				'isSVG'    => true,
				'isInput'  => false,
				'wrapper'  => '{{WRAPPER}}',
			)
