...
$img                                       = $settings['yb_img'];
$num                                       = ! empty( $settings['yb_num'] ) ? $settings['yb_num'] : 'four';
$num_laptop                                = ! empty( $settings['yb_num_laptop'] ) ? $settings['yb_num_laptop'] : $num;
$num_tablet_extra                          = ! empty( $settings['yb_num_tablet_extra'] ) ? $settings['yb_num_tablet_extra'] : $num_laptop;
$num_tablet                                = ! empty( $settings['yb_num_tablet'] ) ? $settings['yb_num_tablet'] : $num_tablet_extra;
$num_mobile_extra                          = ! empty( $settings['yb_num_mobile_extra'] ) ? $settings['yb_num_mobile_extra'] : $num_tablet;
$num_mobile                                = ! empty( $settings['yb_num_mobile'] ) ? $settings['yb_num_mobile'] : $num_mobile_extra;
...
$settings['inc_owl_item_tablet']           = ! empty( $settings['inc_owl_item_tablet'] ) ? $settings['inc_owl_item_tablet'] : '2';
$settings['inc_owl_item_mobile']           = ! empty( $settings['inc_owl_item_mobile'] ) ? $settings['inc_owl_item_mobile'] : '1';
...
if ( $img ) {
	...
	>
		<?php foreach ( $img as $image ) { ?>
			<div class="kata-brands-items kata-lazyload brands-items-<?php echo esc_attr( $num ); ?> brands-items-<?php echo esc_attr( $num_laptop ); ?>-lap brands-items-<?php echo esc_attr( $num_tablet_extra ); ?>-tabex brands-items-<?php echo esc_attr( $num_tablet ); ?>-tab brands-items-<?php echo esc_attr( $num_mobile_extra ); ?>-mobex brands-items-<?php echo esc_attr( $num_mobile ); ?>-mob">
