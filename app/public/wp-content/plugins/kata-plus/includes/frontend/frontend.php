...
if ( ! class_exists( 'Kata_Plus_Frontend' ) ) {
	class Kata_Plus_Frontend {
		...
		public static function kata_plus_social_share( $socials = array(), $socials_icon = array(), $socials_image = array(), $icon_image = '', $image_size = array() ) {
			...
			case 'facebook':
				if ( $icon_image == 'icon' ) {
					echo '<a href="http://www.facebook.com/sharer.php?u=' . get_the_permalink( get_the_ID() ) . '" target="_blank" class="kata-social-share-facebook" aria-label="' . esc_attr__( 'Share on Facebook', 'kata-plus' ) . '">
					...
					case 'twitter':
						if ( $icon_image == 'icon' ) {
							echo '<a href="https://twitter.com/share?url=' . get_the_permalink( get_the_ID() ) . '" target="_blank" class="kata-social-share-twitter" aria-label="' . esc_attr__( 'Share on Twitter', 'kata-plus' ) . '">
					...
					case 'linkedin':
						if ( $icon_image == 'icon' ) {
							echo '<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=' . get_the_permalink( get_the_ID() ) . '" target="_blank" class="kata-social-share-linkedin" aria-label="' . esc_attr__( 'Share on LinkedIn', 'kata-plus' ) . '">
					...
					case 'email':
						if ( $icon_image == 'icon' ) {
							echo '<a href="mailto:? ' . get_the_permalink( get_the_ID() ) . '" class="kata-social-share-email" aria-label="' . esc_attr__( 'Share on Email', 'kata-plus' ) . '">
					...
					case 'pinterest':
						if ( $icon_image == 'icon' ) {
							echo '<a href="' . esc_url( 'http://pinterest.com/pin/create/button/?url=' . esc_url( get_the_permalink( get_the_ID() ) ) ) . '" target="_blank" class="kata-social-share-pinterest" aria-label="' . esc_attr__( 'Share on Pinterest', 'kata-plus' ) . '">
					...
					case 'reddit':
						if ( $icon_image == 'icon' ) {
							echo '<a href="' . esc_url( 'https://reddit.com/submit?url=' . esc_url( get_the_permalink( get_the_ID() ) ) . '/&title=' . get_the_title( get_the_ID() ) ) . '" target="_blank" class="kata-social-share-reddit" aria-label="' . esc_attr__( 'Share on Reddit', 'kata-plus' ) . '">
