    ...
    var WidgetCourselHandler = function ($scope, $) {
        ...
        $(".kata-plus-carousel-grid").each(function () {
            ...
            $('.kata-owl').each(function (index, element) {
                ...
                // Mouse / trackpad scroll navigation.
                $this.on('wheel', function (e) {
                    // Normalize original event for cross-browser support.
                    var oe = e.originalEvent || e;
                    if (!oe) {
                        return;
                    }

                    // Use vertical delta to move carousel horizontally.
                    var deltaY = oe.deltaY || oe.wheelDeltaY || (-oe.wheelDelta) || 0;
