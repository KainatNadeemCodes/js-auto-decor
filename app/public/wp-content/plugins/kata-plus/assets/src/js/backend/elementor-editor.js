					...
					if (e.currentTarget.className == 'elementor-element') {
						...
						if (
							...
							$msg.find('.dialog-buttons-wrapper').html(
								'<a href="https://my.webnus.net/pricing/" target="_blank" class="kata-plus-pro-button dialog-button dialog-action dialog-buttons-action elementor-button elementor-button-success">Kata Pro</a>'
							);
						} else {
							$msg.find('.dialog-buttons-wrapper').html(
