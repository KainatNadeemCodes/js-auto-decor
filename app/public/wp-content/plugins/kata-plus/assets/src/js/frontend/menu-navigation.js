(function ($) {
	...
	var WidgetMenuNavigationHandler = function ($scope, $) {
		var $menuWrap = $scope.find('.kata-menu-wrap'),
			rawConfig = $menuWrap.attr('data-responsive-config'),
			rawBreakpoints = $menuWrap.attr('data-responsive-breakpoints'),
			responsiveConfig = {},
			responsiveBreakpoints = {};

		if (rawConfig) {
			try {
				responsiveConfig = JSON.parse(rawConfig);
			} catch (e) {
				responsiveConfig = {};
			}
		}
		...
		if (rawBreakpoints) {
			try {
				responsiveBreakpoints = JSON.parse(rawBreakpoints);
			} catch (e) {
				responsiveBreakpoints = {};
			}
		}
