...
if ( $display_as_slider ) {
	...
	$attributes .= ' data-slick="' . esc_attr( wp_json_encode( $slider_attrs ) ) . '"';
...
<div id="sp-products-categories-<?php echo esc_attr( wp_rand( 0, 999 ) ); ?>" class="sp-products-categories">
	<?php if ( $terms ) : ?>
		<div class="sp-product-categories-items <?php echo esc_attr( $classes ); ?>" <?php echo $attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Pre-escaped data-slick. ?>>
