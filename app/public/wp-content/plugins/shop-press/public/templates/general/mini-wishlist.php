...
<div class="sp-header-toggle sp-header-wishlist <?php echo esc_attr( $args['open_in'] ); ?> sp-open-<?php echo esc_attr( $args['open_in'] ); ?>">
	...
	<div class="sp-header-toggle-content-wrap" style="display: none;">
		...
		<div class="sp-mini-wishlist">
			...
			<div class="sp-wishlist-items">
				<?php echo wp_kses_post( MenuWishlist::wishlist_content( $wishlist ) ); ?>
			</div>
		</div>
	</div>
</div>
