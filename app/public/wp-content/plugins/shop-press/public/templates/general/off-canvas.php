...
<div class="sp-header-toggle <?php echo esc_attr( $args['open_in'] ); ?> sp-open-<?php echo esc_attr( $args['open_in'] ); ?>">
	...
	if ( $args['header_toggle_template'] ) :
		...
		<div class="sp-header-toggle-content-wrap" style="display: none;">
			...
			if ( $template ) {
				...
				echo '<p>' . esc_html( __( 'Please Choose a valid template', 'shop-press' ) ) . '</p>';
			}
			?>
		</div>
		<?php
	else :
		echo esc_html( __( 'Please Choose Template', 'shop-press' ) );
	endif;
	?>
</div>
