		...
		<div class="sp-shopify-content">
			<div class="sp-shopify-form">
				<div class="sp-shopify-tabs-wrapper">
					<?php if ( $logo != '' ) { ?>
						<img class="logo-shopify-checkout" src="<?php echo esc_url( $logo['url'] ); ?>"/>
					<?php } else { ?>
					...
					<?php if ( $is_cart_navigation ) : ?>
						<ul class="sp-shopify-tabs-list">
							...
							<li class="sp-shopify-tab-item sp-shopify-cart" data-step-title="cart'">
								...
								<?php echo sp_kses_post( $arrow_right ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML sanitized via sp_kses_post(). ?>
							</li>

							<li class="sp-shopify-tab-item sp-shopify-information<?php echo is_user_logged_in() ? ' current' : ''; ?>"
