					...
					switch ( $column_id ) {
						case 'quantity':
							...
							if ( ! $grouped_product_child->is_purchasable() || $grouped_product_child->has_options() || ! $grouped_product_child->is_in_stock() ) {
								...
								/* phpcs:ignore WordPress.WP.I18n.TextDomainMismatch -- WooCommerce template override. */
								...
								woocommerce_quantity_input(
									array(
										...
										'input_value' => ( isset( $_POST['quantity'] ) && is_array( $_POST['quantity'] ) && isset( $_POST['quantity'][ $grouped_product_child->get_id() ] ) ) ? wc_stock_amount( wp_unslash( $_POST['quantity'][ $grouped_product_child->get_id() ] ) ) : '', // phpcs:ignore WordPress.Security.NonceVerification.Missing, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- WooCommerce grouped form.
