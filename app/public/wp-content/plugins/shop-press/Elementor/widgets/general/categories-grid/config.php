...
class CategoriesGrid extends ShopPressWidgets {
	...
	public function get_style_depends() {
		// 'slick' is required for the carousel layout; without it the grid breaks
		// on the frontend when "carousel" is enabled.
		return array( 'sp-categories-grid', 'slick' );
	}

	public function get_script_depends() {
		// The carousel relies on slick and on sp_slider_init() (defined in the
		// core frontend script). Previously no scripts were declared, so the
		// carousel only initialised in the editor.
		return array( 'slick', 'sp-frontend' );
	}
	...
	protected function render() {
		...
		// Initialise the carousel on both the editor and the frontend. This was
		// previously editor-only, which left the carousel uninitialised on the
		// frontend.
