	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'     => '%name%',
				'description' => sprintf(
				/* translators: %1$s: name placeholder, %2$s: code placeholder, %3$s: symbol placeholder, %4$s: name placeholder. */
				__( 'Default: %1$s Available parameters: %2$s, %3$s, %4$s', 'shop-press' ),
				'%name%',
				'%code%',
				'%symbol%',
				'%name%'
