	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'label_on'    => __( 'Yes', 'shop-press' ),
				'label_off'   => __( 'No', 'shop-press' ),
				'description' => esc_html__( 'When you activate this option, the button will be positioned as an overlay on the parent section. Its position will be set to "absolute" and you can determine the exact location of this button in the style tab by using the styler associated with the Wrapper.', 'shop-press' ),
			)
		);
