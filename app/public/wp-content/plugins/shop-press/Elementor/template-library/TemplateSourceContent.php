...
class TemplateSourceContent extends Source_Base {
	 ...
	 *
	 * Retrieve remote templates from webnus servers.
	 *
	 * @since 1.2.0
	 * @access public
	 *
	 ...
	 * Get remote template.
	 *
	 * Retrieve a single remote template from webnus servers.
	 *
	 * @since 1.2.0
	 * @access public
	 *
	 ...
	 *
	 * Remote template from webnus servers cannot be saved on the
	 ...
	 *
	 * Remote template from webnus servers cannot be updated on the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.2.0
	 * @access public
	 ...
	 *
	 * Remote template from webnus servers cannot be deleted from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.2.0
	 * @access public
	 ...
	 *
	 * Remote template from webnus servers cannot be exported from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.2.0
	 * @access public
	 ...
	 *
	 * Retrieve the data of a single remote template from webnus servers.
	 *
	 * @since 1.2.0
	 * @access public
	 *
