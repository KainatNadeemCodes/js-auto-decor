...
class Admin {
	...
	public static function product_taxonomy_custom_metadata( $term ) {
		...
		<tr class="form-field">
			<th scope="row" valign="top">
				<label for="single_product_template"><?php esc_html_e( 'Single Product Template', 'shop-press' ); ?></label>
			</th>
			<td>
				<select name="single_product_template" id="single_product_template">
					<option value=""><?php echo esc_html( __( 'Default', 'shop-press' ) ); ?></option>
	...
	public static function save_product_taxonomy_custom_metadata( $term_id ) {
		...
		if ( $nonce_valid && isset( $_POST['single_product_template'] ) ) {
			update_term_meta( $term_id, 'single_product_template', sanitize_text_field( wp_unslash( $_POST['single_product_template'] ) ) );
		}
	}
	...
	public static function save_product( $post_id, $post ) {
		...
		$template = isset( $_POST['shoppress_woo_custom_templates'] ) ? sanitize_text_field( wp_unslash( $_POST['shoppress_woo_custom_templates'] ) ) : '';
