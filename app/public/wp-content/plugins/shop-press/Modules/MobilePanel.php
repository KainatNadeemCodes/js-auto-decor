				...
				foreach ( $items as $item ) :
					...
					<div class="sp-mp-item <?php echo esc_attr( $classes ); ?>">
						<a href="<?php echo esc_url( $link ); ?>">
							<?php echo sp_kses_post( $icon_html ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML sanitized via sp_kses_post(). ?>
							<p><?php echo esc_html( $label ); ?></p>
							<?php echo sp_kses_post( $more_content ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- HTML sanitized via sp_kses_post(). ?>
						</a>
					</div>
				<?php endforeach; ?>
			<?php endif; ?>
