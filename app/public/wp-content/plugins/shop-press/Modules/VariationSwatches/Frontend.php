...
class Frontend {
	...
	public function default_variation_field( $html, $args, $attr, $design_type ) {
		...
		if ( false === $args['selected'] && $args['attribute'] && $args['product'] instanceof WC_Product ) {
			...
			$args['selected'] = isset( $_REQUEST[ $selected_key ] ) ? wc_clean( sanitize_text_field( wp_unslash( $_REQUEST[ $selected_key ] ) ) ) : $args['product']->get_variation_default_attribute( $args['attribute'] ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Product variation form.
		}
