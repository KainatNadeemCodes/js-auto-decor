...
final class Plugin {
	...
	public function load_plugin_textdomain() {
		// phpcs:ignore PluginCheck.CodeAnalysis.DiscouragedFunctions.load_plugin_textdomainFound -- Required for plugin translations.
	...
	private function load_dependencies() {
		if (file_exists(SHOPPRESS_PATH . 'auto-update.php')) {
			require_once SHOPPRESS_PATH . 'auto-update.php';
		}
		// General functions
		require_once SHOPPRESS_PATH . 'includes/functions/functions-general.php';

		// Embedded Styler (Elementor styling control).
		if ( file_exists( SHOPPRESS_PATH . 'includes/styler/styler.php' ) ) {
