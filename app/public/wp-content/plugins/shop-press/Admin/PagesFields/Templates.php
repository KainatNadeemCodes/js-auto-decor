		...
		$fields = array(
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-single-product-page/',
				),
			),
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-shop-page/',
				),
			),
			array(
			...
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-checkout-manager/',
				),
			),
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-archive-page/',
				),
			),
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-products-loop-page/',
				),
			),
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-my-account-page/',
				),
			),
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-cart-page/',
				),
			),
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-empty-cart-page/',
				),
			),
			array(
			...
			array(
				...
				'tooltip' => array(
					...
					'link'    => 'https://webnus.net/shoppress/helpdesk/woocommerce-thank-you-page/',
				),
			),
		);
